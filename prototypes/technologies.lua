data:extend({
    {
        ...
        icon = "__Dimensional-Chests__/graphics/1x1/entity.png",
        icon_size = 512,
        unit = {
            count = 10,
    ...
    },
    {
        ...
        icon = "__Dimensional-Chests__/graphics/2x2/entity.png",
        icon_size = 512,
        unit = {
            count = 20,
    ...
    },
    {
        ...
        icon = "__Dimensional-Chests__/graphics/3x3/entity.png",
        icon_size = 512,
        unit = {
            count = 30,
    ...
    },
    {
        ...
        icon = "__Dimensional-Chests__/graphics/4x4/entity.png",
        icon_size = 512,
        unit = {
            count = 40,
    ...
    },
    {
        ...
        icon = "__Dimensional-Chests__/graphics/5x5/entity.png",
        icon_size = 512,
        unit = {
            count = 50,
            ingredients = {{"automation-science-pack", 1}, {"logistic-science-pack", 1}, {"chemical-science-pack", 1}, {"production-science-pack", 1}},
    ...
    },
    {
        ...
        icon = "__Dimensional-Chests__/graphics/6x6/entity.png",
        icon_size = 512,
        unit = {
            count = 60,
    ...
    -- Technologie du réservoir dimensionnel (fluide)
    {
        type = "technology",
        name = "communicating-tank-tech",
        localised_name = "Technologie Réservoir Dimensionnel",
        localised_description = "Permet de construire le réservoir dimensionnel.",
        icon = "__Dimensional-Chests__/graphics/tank/entity.png",
        icon_size = 512,
        unit = {
            count = 30,
            ingredients = {{"automation-science-pack", 1}, {"logistic-science-pack", 1}, {"chemical-science-pack", 1}},
        ...
        effects = {
            {type = "unlock-recipe", recipe = "reservoir-dimensionnel"}
        },
        prerequisites = {"communicating-chest-tech-3", "fluid-handling"}
    }
})
