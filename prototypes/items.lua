...
data:extend({
    ...
    -- Réservoir dimensionnel (fluide)
    {
        type = "item",
        name = "reservoir-dimensionnel",
        localised_name = "Réservoir Dimensionnel",
        localised_description = "Un réservoir capable de se connecter au réseau dimensionnel de fluides.",
        icon = "__Dimensional-Chests__/graphics/tank/entity.png",
        icon_size = 512,
        subgroup = "storage",
        order = "b[tank]-1",
        place_result = "reservoir-dimensionnel",
        stack_size = 5
    }
})
